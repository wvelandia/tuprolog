This example requires a MySQL (http://www.mysql.com/) server running on the machine and the presence of the following table:
...
The parameters to access the DB has to be modified in StockAnalyzer\java\com\JDBCadapter.java
