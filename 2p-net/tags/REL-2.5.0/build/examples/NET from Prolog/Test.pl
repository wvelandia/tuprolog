...
% Due to differences between the .net class model and java class model, to let tuProlog find the java classes
% they have to be put in the same directory of the application and only there (CodeBase and PrivatePath
% configurations will be not used to search java classes).
testBasicsWithJava :-
