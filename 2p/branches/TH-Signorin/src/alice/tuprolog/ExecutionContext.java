...
public class ExecutionContext {
    ...
    void performTailRecursionOptimization(Engine e){
    	 	...
    	 	if(!e.manager.spying() && (!haveAlternatives && !e.currentContext.goalsToEval.haveSubGoals() && !(e.currentContext.currentGoal.getName().equalsIgnoreCase("catch") || e.currentContext.currentGoal.getName().equalsIgnoreCase("java_catch"))))
        		{
