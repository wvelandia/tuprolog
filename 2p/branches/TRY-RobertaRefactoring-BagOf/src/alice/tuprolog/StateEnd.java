...
public class StateEnd extends State {
    ...
    void doJob(Engine e) {
        ...
        System.out.println("STAMPO LE VAR del GOAL****"+e.goalVars);
        System.out.println("STATE END "+vars+ " GOAL "+goal);  
    ...
    private void relinkVar(Engine e){
	    if(c.getEngineMan().getRelinkVar()){ //devo fare il relink solo se ho var libere nella bagof E SE NON CI SONO ESISTENZE
	    	 ...
	    	 */
	    	System.out.println("Le var del risultato sono "+(c.getEngineMan()).getBagOFres());     	
