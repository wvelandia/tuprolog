...
\color{red}
Accordingly, such exceptions are handled in \tuprolog{}.NET via one further, \textit{ad hoc} predicate, %\texttt{oo\_throw/1} and 
\texttt{oo\_catch/3}, which constitute the .NET counterpart of JavaLibrary's %\texttt{java\_throw/1} and 
\texttt{java\_catch/3}.
\normalcolor
%
