...
As an example, let us consider the following TCP server-side code:\\
...
Consequently, \texttt{AbstractSocket} redefines some \texttt{Term} methods and defines some new abstract methods, implemented in \texttt{Client\_Socket} and \texttt{Server\_Socket}:
\begin{itemize}
