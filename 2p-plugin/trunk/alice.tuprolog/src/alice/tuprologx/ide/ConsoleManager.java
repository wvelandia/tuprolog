	...
	implements QueryListener, Console, PropertyChangeListener
{
	...
	private ArrayList informationToDisplayListeners;
	...
	{
		Iterator it = informationToDisplayListeners.listIterator();
		while (it.hasNext())
			((InformationToDisplayListener) it.next()).onInformation(e);
